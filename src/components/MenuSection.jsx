                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 sm:gap-1.5 mb-1.5 sm:mb-2.5">
                    {item.tags.map((tag, idx) => (
                      <span
                        key={idx}
                        className={`text-[8px] sm:text-[10px] uppercase font-bold tracking-wider px-1.5 sm:px-2.5 py-0.5 rounded-md border ${
                          tag === 'Most Sold'
                            ? 'bg-amber-400 text-gray-950 font-black border-amber-500 shadow-sm'
                            : 'bg-gray-100/80 text-black border-gray-900/20'
                        }`}
                      >
                        {tag}
                      </span>
